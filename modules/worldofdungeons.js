...
Hooks.on("renderSettings", (app, html) => {
  let sheetConfigBtn = $(`<button id="manual-sheet-config" title="${game.i18n.localize("WoDu.Button.Hint")}"><i class="fas fa-scroll"></i> ${game.i18n.localize("WoDu.Button.Title")}</button>`);
  html.find('button[data-action="configure"]').before(sheetConfigBtn);

  sheetConfigBtn.on('click', ev => {
    ev.preventDefault();
    configSheet();
  });
